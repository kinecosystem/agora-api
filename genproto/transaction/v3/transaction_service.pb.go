...
func (m *SubmitTransactionRequest) GetTransactionXdr() []byte {
	if m != nil {
...
type SubmitTransactionResponse struct {
	Result SubmitTransactionResponse_Result `protobuf:"varint,1,opt,name=result,proto3,enum=kin.transaction.v3.SubmitTransactionResponse_Result" json:"result,omitempty"`
...
type SubmitTransactionResponse_InvoiceError struct {
	...
	Reason               SubmitTransactionResponse_InvoiceError_Reason `protobuf:"varint,3,opt,name=reason,proto3,enum=kin.transaction.v3.SubmitTransactionResponse_InvoiceError_Reason" json:"reason,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                      `json:"-"`
	XXX_unrecognized     []byte                                        `json:"-"`
	XXX_sizecache        int32                                         `json:"-"`
}
...
type HistoryItem struct {
	...
	ForeignKey   []byte           `protobuf:"bytes,6,opt,name=foreign_key,json=foreignKey,proto3" json:"foreign_key,omitempty"`
	// If the service was able to resolve, or manages, the off-chain chain
	// data associated with the memo, op_agora_data will be populated.
	//
	// Each item in the list corresponds to the operation in the transaction
	// with that same index. That is, operation[i] has op_agora_data[i].
	OpAgoraData          []*v3.AgoraData `protobuf:"bytes,7,rep,name=op_agora_data,json=opAgoraData,proto3" json:"op_agora_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *HistoryItem) GetForeignKey() []byte {
	if m != nil {
		return m.ForeignKey
	}
	return nil
...
func (m *HistoryItem) GetOpAgoraData() []*v3.AgoraData {
	if m != nil {
		return m.OpAgoraData
	}
	return nil
}
...
func init() {
	...
	proto.RegisterEnum("kin.transaction.v3.SubmitTransactionResponse_Result", SubmitTransactionResponse_Result_name, SubmitTransactionResponse_Result_value)
	proto.RegisterEnum("kin.transaction.v3.SubmitTransactionResponse_InvoiceError_Reason", SubmitTransactionResponse_InvoiceError_Reason_name, SubmitTransactionResponse_InvoiceError_Reason_value)
	...
	proto.RegisterType((*SubmitTransactionRequest)(nil), "kin.transaction.v3.SubmitTransactionRequest")
	proto.RegisterType((*SubmitTransactionResponse)(nil), "kin.transaction.v3.SubmitTransactionResponse")
	proto.RegisterType((*SubmitTransactionResponse_InvoiceError)(nil), "kin.transaction.v3.SubmitTransactionResponse.InvoiceError")
...
var fileDescriptor_67d4eb25f503063e = []byte{
	...
	,
}
...
func (c *transactionClient) SubmitTransaction(ctx context.Context, in *SubmitTransactionRequest, opts ...grpc.CallOption) (*SubmitTransactionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kin.transaction.v3.Transaction/SubmitTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Transaction_SubmitTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kin.transaction.v3.Transaction/SubmitTransaction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
